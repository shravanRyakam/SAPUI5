		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comemployeedetailsemployeedetails-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comemployeedetailsemployeedetails-display": {
								"semanticObject": "comemployeedetailsemployeedetails",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.employeedetails.employeedetails",
									"url": sap.ui.require.toUrl("com/employeedetails/employeedetails")
								}
							}
						}
					}
